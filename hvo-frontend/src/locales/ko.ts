const ko = {
  translation: {
    ...
    companyPolicies: {
      title: '회사 정책',
      subtitle:
        '고용·근태·휴가·급여·기밀·POSH·퇴직 등 정책을 확인합니다. 회사 관리자는 탭 추가·삭제와 내용 수정이 가능하며 변경 이력이 기록됩니다.',
      empty: '표시할 정책이 없습니다.',
      emptyContent: '등록된 내용이 없습니다.',
      readOnlyHint: '일반 직원은 조회만 가능합니다. 탭 추가·삭제·수정은 회사 관리자(admin)만 할 수 있습니다.',
      version: '버전 {{version}}',
      updatedBy: '수정: {{name}}',
      historyTitle: '변경 이력',
      historyEmpty: '변경 이력이 없습니다.',
      revisionTitle: '버전 {{version}} 내용',
      addTabHint: '새 탭은 한국어·영어 제목으로 추가되며. 내용은 추가 후 「수정」에서 작성하세요.',
      confirmDeleteTab: '「{{name}}」 탭을 삭제하시겠습니까? (목록에서만 숨기며, 이력은 유지됩니다.)',
      tabs: {
        employment: '고용 정책',
        attendance: '근태 정책',
        leave: '휴가 정책',
        salaryPayroll: '급여·페이롤 정책',
        confidentialityData: '기밀·데이터 정책',
        posh: 'POSH',
        separation: '퇴직·이직 정책',
      },
      fields: {
    ...
    auth: {
      loginTitle: 'Hyvision One 로그인',
      loginSubtitle: '차세대 기업용 통합 업무 관리 시스템',
      userId: '사용자 ID',
      password: '비밀번호',
      loginButton: 'Hyvision One 로그인',
    ...
    dashboard: {
      ...
      optimal: '최적',
      active: '활성',
      enterpriseFeatures: 'Hyvision One - 차세대 기업용 통합 업무 관리 시스템',
    ...
    userManagement: {
      title: '사용자 관리',
      description: 'Hyvision One 시스템 사용자 계정을 관리합니다.',
      userList: '사용자 목록',
      addUser: '사용자 추가',
      departmentTab: '부서 관리',
      positionTab: '직책 관리',
    ...
    attendanceManagement: {
      ...
      heresnowDescription: 'HeresNow(www.heresnow.in) 출·퇴근 기록을 Hyvision One 근태로 가져옵니다.',
    ...
    companyManagement: {
      title: '회사 관리',
      pageTitle: '회사 정보 관리',
      description: 'Hyvision One 시스템을 사용할 수 있는 회사 목록을 관리합니다.',
      ...
      noCompaniesTitle: 'Hyvision One 시스템을 사용할 수 있는 회사가 없습니다',
      active: '활성',
      inactive: '비활성',
      suspended: '중단',
      hvoUsageCompanies: 'Hyvision One 사용 회사',
      ...
      companyListTitle: 'Hyvision One 시스템 사용 회사 목록 ({{count}}개)',
      companyInfo: '회사 정보',
      hvoUsagePeriod: 'Hyvision One 사용 기간',
      close: '닫기',
      saving: '저장 중...',
    ...
    partnerManagement: {
      ...
      placeholderGstRequired: 'GST 번호 (선택)',
      ...
      companyNameRequired: '회사명을 입력해 주세요.',
    ...
    systemSettings: {
      pageTitle: '시스템 설정',
      pageDescription: '언어·테마·알림·보안·메일 서버 등 Hyvision One 시스템 전역 설정을 관리합니다.',
      stats: {
        language: '언어',
        theme: '테마',
        smtp: 'SMTP',
      ...
      general: {
        ...
        companyAbbreviationHint: '견적 메일 제목 [HVO] 형식에 사용됩니다. 예: HVO'
      },
      tabs: {
        basic: '기본 설정',
    ...
    payrollManagement: {
      ...
      payslipSendSystem: {
        title: '급여 명세서 발송',
        description:
          '급여 리스트를 업로드해 내용을 검수하고, 직원별 PDF 급여 명세서를 이메일로 발송합니다. 엑셀 원본은 저장하지 않으며, Hyvision One 사용자와 이메일이 일치하면 내 급여 명세서에만 보관됩니다.',
        completeOnlyHint:
        ...
        sendSaved: ' (Hyvision One 사용자 명세서 저장 {{saved}}건)',
        issues: {
          missingName: '성명 없음',
      ...
      excelImport: {
        title: '급여 엑셀 업로드',
        hint: '선택한 급여월 {{period}}에 매칭된 직원 급여를 저장합니다. 이메일이 우선이며, 없으면 사번으로 매칭합니다.',
        selectFile: '엑셀 파일 선택',
        emptyHint: '엑셀 파일(.xlsx)을 선택하면 미리보기가 표시됩니다.',
        confirm: '가져오기',
        noRows: '가져올 급여 행이 없습니다.',
        noSheet: '읽을 수 있는 시트가 없습니다.',
        parseFailed: '엑셀을 읽지 못했습니다. .xlsx 파일인지 확인하세요.',
        importFailed: '급여 엑셀 가져오기에 실패했습니다.',
        resultSummary: '생성 {{created}}건 / 교체(비활성) {{replaced}}건 / 건너뜀 {{skipped}}건',
        colRow: '행',
        colName: '성명',
        colEmail: '이메일',
        colMatch: '매칭',
        ...
        colReason: '사유',
        skipReasons: {
          missing_email_and_emp_id: '이메일·사번 없음',
          no_matching_user: '매칭 사용자 없음',
          duplicate_employee: '파일 내 중복 직원',
        },
      },
    },
    myPayrollList: {
      title: '내 급여 목록',
      description: '본인 계정에 매칭된 급여 내역을 조회합니다.',
      period: '급여월',
      search: '조회',
      columns: {
        period: '급여월',
      ...
      empty: {
        loading: '급여 목록을 불러오는 중입니다.',
        noItems: '표시할 급여가 없습니다.',
        noItemsHint: '인사팀에서 엑셀 업로드 또는 급여 생성 후 확인할 수 있습니다.',
      },
      errors: {
        loadFailed: '급여 목록을 불러오지 못했습니다.',
      },
    },
    ...
    eInvoiceManagement: {
      ...
      gst: {
        title: 'GST 규정 준수 현황',
        irpWorkflow:
          '법적 IRN은 Invoice Registration Portal(IRP)에서 발급됩니다. Hyvision One는 NIC 스키마 JSON을 구성한 뒤 제출합니다. 기본(GST_IRP_MODE=mock)은 개발용 시뮬레이션입니다. 운영 시 GSP 계약 후 GST_GSP_BASE_URL 등 환경 변수로 연동하세요.',
        checklist: {
    ...
    tallyImport: {
      ...
      description:
        'Tally Export XML/JSON을 검토한 뒤 Hyvision One 임시 전표로 변환합니다. 전표는 draft 상태로만 생성되며 자동 전기되지 않습니다.',
      wizard: {
        upload: '파일 업로드',
        inspect: '파일 구조 확인',
        mapping: '매핑',
      ...
      steps: {
        ...
        mappingHint: 'Tally Ledger·Voucher를 Hyvision One 계정·전표로 가져올 범위와 자동 생성 규칙을 선택합니다.',
        reviewTitle: '4. 오류 검토',
      ...
      reconciliationPass: 'Tally 원본 거래와 Hyvision One Draft 전표의 현재 이관 범위가 일치합니다.',
    ...
    balanceSheet: {
      ...
      hint: '시트 금액은 동일 Hyvision One 집계(BS / 손익 / 시산표)에서 계산됩니다. 스케줄 합계가 본표(BS·PL)와 맞춰집니다.',
    ...
    hqPortal: {
      dashboardTitle: '본사 통합 대시보드',
      dashboardDesc: '한국 본사에서 인도법인 KPI·승인·컴플라이언스를 모니터링합니다. 카드를 클릭하면 원장/문서로 이동합니다.',
      refresh: '새로고침',
      loadFailed: '대시보드를 불러오지 못했습니다.',
      finance: '재무',
      purchaseInventory: '구매·재고',
      production: '생산',
      sales: '판매',
      compliance: '세무·Compliance',
      pendingApprovals: '승인 대기',
      approvalsTitle: '본사 승인',
      approvalsDesc: '고액 구매·BOM 변경·기간 재오픈 등 본사 승인 요청입니다.',
      docType: '문서유형',
      docNo: '문서번호',
      partner: '거래처',
      amount: '금액',
      ...
      reject: '반려',
      reportsTitle: '본사 리포트',
      reportsDesc: '경영·생산·재고·세무 보고서. Snapshot으로 제출 시점 데이터를 보존합니다.',
      catalog: '보고서 목록',
      snapshots: 'Snapshot',
      reportKey: '키',
      reportName: '보고서명',
      period: '기간',
      createdAt: '생성',
      snapshotSaved: 'Snapshot이 저장되었습니다.',
      complianceTitle: '컴플라이언스',
      complianceDesc: 'GSTR/TDS/라이선스 등 법정·내부 일정입니다.',
      type: '유형',
      dueDate: '기한',
      fxTitle: '환율',
      fxDesc: 'INR·KRW·USD 환산 환율. 기준일·출처를 저장하며 확정 전표는 소급 변경하지 않습니다.',
      rateDate: '기준일',
      rate: '환율',
      source: '출처',
      saveRate: '환율 저장',
      accessLogsTitle: '접근 로그',
      accessLogsDesc: '본사 조회·Export·승인 이력입니다.',
      privacyTitle: '개인정보·국외접근 설정',
      privacyDesc: '수집 목적·보관기간·처리근거를 운영 설정으로 관리합니다. 법령 해석은 하드코딩하지 않습니다.',
      purpose: '수집·이용 목적',
      retentionDays: '보관일수',
      legalBasis: '적법한 처리근거',
      contactEmail: '문의 이메일',
      ...
      saved: '저장되었습니다.',
      usersTitle: '본사 사용자',
      usersDesc: 'Korea HQ 역할·접근 단계·민감정보 권한을 부여합니다.',
    },
    login: {
      welcome: 'Welcome',
      signIn: '계정에 로그인하세요',
      ...
      emailLabel: '이메일 / ID',
      signUpCta: '회원가입',
      footerDevelopedBy: 'Minsub Ventures Private Limited',
      footerCompanyName: 'Hyvision India',
      footerWebsite: 'Hyvision One',
      footerDeveloperUrl: 'https://www.msventures.in',
    ...
    legalPages: {
      ...
      terms: {
        title: '이용약관',
        intro: 'Hyvision One(Hyvision India) 서비스 이용과 관련한 권리·의무 및 책임 사항을 규정합니다.',
        lastUpdated: '2025-06-02',
        sections: [
          {
            title: '제1조 (목적)',
            paragraphs: [
              '본 약관은 Hyvision India(이하 "회사")가 제공하는 Hyvision One 클라우드 ERP 서비스(이하 "서비스")의 이용 조건 및 절차, 회사와 이용자의 권리·의무 및 책임 사항을 규정함을 목적으로 합니다.'
            ]
          },
          {
            title: '제2조 (정의)',
      ...
      support: {
        title: '고객센터',
        intro: 'Hyvision One 서비스 이용 중 궁금한 점이나 기술 지원이 필요하시면 아래 채널로 문의해 주세요.',
        emailLabel: '이메일',
