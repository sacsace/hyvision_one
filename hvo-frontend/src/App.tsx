...
const MfgBranchesPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase1Pages').then((m) => ({ default: m.MfgBranchesPage }))
);
const MfgWarehousesPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase1Pages').then((m) => ({ default: m.MfgWarehousesPage }))
);
const MfgDocumentSequencesPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase1Pages').then((m) => ({ default: m.MfgDocumentSequencesPage }))
);
const MfgPurchaseOrdersPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase1Pages').then((m) => ({ default: m.MfgPurchaseOrdersPage }))
);
const MfgGoodsReceiptsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase1Pages').then((m) => ({ default: m.MfgGoodsReceiptsPage }))
);
const MfgQualityInspectionsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase1Pages').then((m) => ({ default: m.MfgQualityInspectionsPage }))
);
const PurchaseDashboardPage = lazyPage(() =>
  import('./pages/Purchase/PurchasePages').then((m) => ({ default: m.PurchaseDashboardPage }))
);
const PurchaseRequisitionsPage = lazyPage(() =>
  import('./pages/Purchase/PurchasePages').then((m) => ({ default: m.PurchaseRequisitionsPage }))
);
const PurchaseSettingsPage = lazyPage(() =>
  import('./pages/Purchase/PurchasePages').then((m) => ({ default: m.PurchaseSettingsPage }))
);
const PurchaseComingSoonPage = lazyPage(() =>
  import('./pages/Purchase/PurchasePages').then((m) => ({ default: m.PurchaseComingSoonPage }))
);
const MfgStockLedgerPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase1Pages').then((m) => ({ default: m.MfgStockLedgerPage }))
);
const MfgAuditLogsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase1Pages').then((m) => ({ default: m.MfgAuditLogsPage }))
);
const MfgSalesOrdersPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgSalesOrdersPage }))
);
const MfgDeliveryChallansPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgDeliveryChallansPage }))
);
const MfgStockReservationsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgStockReservationsPage }))
);
const MfgCreditNotesPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgCreditNotesPage }))
);
const MfgBomsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgBomsPage }))
);
const MfgWorkCentersPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgWorkCentersPage }))
);
const MfgRoutingsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgRoutingsPage }))
);
const MfgProductionPlansPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgProductionPlansPage }))
);
const MfgWorkOrdersPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgWorkOrdersPage }))
);
const MfgMaterialIssuesPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgMaterialIssuesPage }))
);
const MfgProductionEntriesPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgProductionEntriesPage }))
);
const MfgStandardCostsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgStandardCostsPage }))
);
const MfgTaxConfigurationsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgTaxConfigurationsPage }))
);
const MfgPeriodLocksPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgPeriodLocksPage }))
);
const MfgAutoJournalsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgAutoJournalsPage }))
);
const MfgBudgetsPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgBudgetsPage }))
);
const MfgKpiPage = lazyPage(() =>
  import('./pages/Mfg/MfgPhase2to5Pages').then((m) => ({ default: m.MfgKpiPage }))
);
const HqIntegratedDashboardPage = lazyPage(() =>
  import('./pages/HQ/HqPortalPages').then((m) => ({ default: m.HqIntegratedDashboardPage }))
);
const HqApprovalsPage = lazyPage(() =>
  import('./pages/HQ/HqPortalPages').then((m) => ({ default: m.HqApprovalsPage }))
);
const HqReportsPage = lazyPage(() =>
  import('./pages/HQ/HqPortalPages').then((m) => ({ default: m.HqReportsPage }))
);
const HqCompliancePage = lazyPage(() =>
  import('./pages/HQ/HqPortalPages').then((m) => ({ default: m.HqCompliancePage }))
);
const HqFxRatesPage = lazyPage(() =>
  import('./pages/HQ/HqPortalPages').then((m) => ({ default: m.HqFxRatesPage }))
);
      ...
      <ErrorBoundary>
        ...
        <Router>
          ...
          <Route path="/" element={
            ...
            <Route path="work/assignee-list" element={<Navigate to="/work/projects" replace />} />
            ...
            {/* 제조·구매 Phase 1 */}
            <Route path="mfg" element={<Navigate to="/mfg/branches" replace />} />
            ...
            <Route path="purchase/goods-receipts" element={<MfgGoodsReceiptsPage />} />
            <Route path="purchase/quality-inspections" element={<MfgQualityInspectionsPage />} />
            <Route path="purchase/rfq" element={<PurchaseComingSoonPage />} />
            <Route path="purchase/supplier-quotations" element={<PurchaseComingSoonPage />} />
            <Route path="purchase/quotation-compare" element={<PurchaseComingSoonPage />} />
            <Route path="purchase/invoices" element={<PurchaseComingSoonPage />} />
            <Route path="purchase/returns" element={<PurchaseComingSoonPage />} />
            <Route path="purchase/payment-requests" element={<PurchaseComingSoonPage />} />
            <Route path="purchase/reports" element={<PurchaseComingSoonPage />} />
            <Route path="purchase/suppliers" element={<Navigate to="/basic-info/partners" replace />} />
            <Route path="purchase/settings" element={<PurchaseSettingsPage />} />
            <Route path="mfg/purchase-requisitions" element={<Navigate to="/purchase/requisitions" replace />} />
            <Route path="mfg/purchase-orders" element={<Navigate to="/purchase/orders" replace />} />
            <Route path="mfg/goods-receipts" element={<Navigate to="/purchase/goods-receipts" replace />} />
            <Route path="mfg/quality-inspections" element={<Navigate to="/purchase/quality-inspections" replace />} />
            <Route path="mfg/branches" element={<MfgBranchesPage />} />
            <Route path="mfg/warehouses" element={<MfgWarehousesPage />} />
            <Route path="mfg/document-sequences" element={<MfgDocumentSequencesPage />} />
            <Route path="mfg/stock-ledger" element={<MfgStockLedgerPage />} />
            <Route path="mfg/audit-logs" element={<MfgAuditLogsPage />} />
            <Route path="mfg/sales-orders" element={<MfgSalesOrdersPage />} />
            <Route path="mfg/delivery-challans" element={<MfgDeliveryChallansPage />} />
            <Route path="mfg/stock-reservations" element={<MfgStockReservationsPage />} />
            <Route path="mfg/credit-notes" element={<MfgCreditNotesPage />} />
            <Route path="mfg/boms" element={<MfgBomsPage />} />
            <Route path="mfg/work-centers" element={<MfgWorkCentersPage />} />
            <Route path="mfg/routings" element={<MfgRoutingsPage />} />
            <Route path="mfg/production-plans" element={<MfgProductionPlansPage />} />
            <Route path="mfg/work-orders" element={<MfgWorkOrdersPage />} />
            <Route path="mfg/material-issues" element={<MfgMaterialIssuesPage />} />
            <Route path="mfg/production-entries" element={<MfgProductionEntriesPage />} />
            <Route path="mfg/standard-costs" element={<MfgStandardCostsPage />} />
            <Route path="mfg/tax-configurations" element={<MfgTaxConfigurationsPage />} />
            <Route path="mfg/period-locks" element={<MfgPeriodLocksPage />} />
            <Route path="mfg/auto-journals" element={<MfgAutoJournalsPage />} />
            <Route path="mfg/hq-dashboard" element={<Navigate to="/hq/dashboard" replace />} />
            <Route path="mfg/budgets" element={<MfgBudgetsPage />} />
            <Route path="mfg/kpi" element={<MfgKpiPage />} />
            <Route path="mfg/report-snapshots" element={<Navigate to="/hq/reports" replace />} />
            <Route path="hq" element={<Navigate to="/hq/dashboard" replace />} />
            <Route path="hq/dashboard" element={<HqIntegratedDashboardPage />} />
            <Route path="hq/approvals" element={<HqApprovalsPage />} />
            ...
            <Route path="e-invoice" element={<Navigate to="/accounting/invoice" replace />} />
            <Route path="e-invoice/list" element={<Navigate to="/accounting/invoice" replace />} />
            <Route path="e-invoice/create" element={<Navigate to="/accounting/invoice" replace />} />
            <Route path="e-invoice/send" element={<Navigate to="/accounting/invoice" replace />} />
            <Route path="e-invoice/status" element={<Navigate to="/accounting/invoice" replace />} />
            ...
            <Route path="accounting/e-invoice" element={<Navigate to="/accounting/invoice" replace />} />
            <Route path="accounting/e-invoice/create" element={<Navigate to="/accounting/invoice" replace />} />
