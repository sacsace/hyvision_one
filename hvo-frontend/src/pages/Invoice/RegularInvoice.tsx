          ...
          <CardContent sx={{ p: { xs: 2.5, md: 4 } }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 3 }}>
              ...
              <Stack spacing={1} alignItems="flex-end">
                ...
                <Button variant="outlined" onClick={handleCancelEdit} sx={hvoBodyOutlinedBtnSx}>
                  {tr('취소', 'Cancel')}
                </Button>
              </Stack>
            </Box>
            ...
            <Grid container spacing={1.5}>
              ...
              <Grid size={{ xs: 12 }}>
                <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 2, mt: 3 }}>
                  ...
                  <Button variant="contained" disableElevation onClick={handleSaveInvoice} sx={hvoBodyPrimaryBtnSx}>
                    {tr('저장', 'Save')}
                  </Button>
                </Box>
              </Grid>
