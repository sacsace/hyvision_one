    ...
    <Box sx={{ ...hvoPageRootSx }}>
      ...
      <Dialog open={roomTypeDialogOpen} onClose={() => setRoomTypeDialogOpen(false)} maxWidth="xs" fullWidth>
        ...
        <DialogActions>
          ...
          <Button variant="contained" disableElevation onClick={handleApplyRoomType} sx={hvoBodyPrimaryBtnSx}>
      ...
      <Dialog open={roomNameDialogOpen} onClose={() => setRoomNameDialogOpen(false)} maxWidth="xs" fullWidth>
        ...
        <DialogActions>
          ...
          <Button variant="contained" disableElevation onClick={handleSaveRoomName} sx={hvoBodyPrimaryBtnSx}>
            {t('common.save')}
          </Button>
        </DialogActions>
      </Dialog>
