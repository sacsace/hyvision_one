...
export function toPayslipCompanyInfo(company: any): PayslipCompanyInfo {
  ...
  const logoTrimmed = typeof logoRaw === 'string' ? logoRaw.trim() : '';
  return {
    name: company?.name || '',
  ...
  return (
    <Box
      sx={{
        ...
        borderBottom: isLast ? 'none' : `1px solid ${HVO_ROW_BORDER}`,
  ...
  return (
    <Box
      sx={{
        ...
        py: 1.25,
        bgcolor: '#F1F5F9',
        borderBottom: `1px solid ${HVO_ROW_BORDER}`,
        borderTop: '2px solid',
...
function EarningsDeductionsTable({
  ...
  return (
    <Box sx={{ ...hvoBodyTableFrameSx, mb: forPdf ? 1.5 : 2.5, overflow: 'hidden' }}>
      ...
      <Box
        sx={{
          ...
          borderTop: `1px solid ${HVO_ROW_BORDER}`
        }}
      >
        <LedgerRow
    ...
    >
      <Box sx={{ ...hvoBodyCardSx, overflow: 'hidden' }}>
        ...
        <Box sx={{ px: { xs: 2, sm: 2.5 }, pb: forPdf ? 1.5 : 2.5, pt: forPdf ? 1.5 : 2.5 }}>
          ...
          <Box sx={{ ...hvoBodyTableInsetSx, mb: forPdf ? 1.5 : 3, borderRadius: '8px', overflow: 'hidden' }}>
            <Box
              sx={{
                ...hvoBodyTableFrameSx,
