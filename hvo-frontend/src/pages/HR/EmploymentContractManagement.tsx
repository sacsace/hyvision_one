        ...
        {loading ? (
          ...
          contracts.length === 0 ? (
            renderEmptyState({
              ...
              action: canManage ? (
                <Button variant="contained" disableElevation size="small" startIcon={<AddIcon fontSize="small" />} onClick={openCreateContract} sx={hvoBodyPrimaryBtnSx}>
                  {t('employmentContractManagement.createContract')}
                </Button>
              ) : undefined,
            })
            ...
            <>
              ...
              <Box sx={{ ...hvoBodyListTableSx, mt: 2.5, p: 2 }}>
          ...
          templates.length === 0 ? (
            renderEmptyState({
              ...
              action: canManage ? (
                <Button variant="contained" disableElevation size="small" startIcon={<AddIcon fontSize="small" />} onClick={openCreateTemplate} sx={hvoBodyPrimaryBtnSx}>
                  {t('employmentContractManagement.createTemplate')}
                </Button>
              ) : undefined,
            })
