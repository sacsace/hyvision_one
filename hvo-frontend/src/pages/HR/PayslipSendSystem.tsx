...
const PayslipSendSystem: React.FC = () => {
  ...
  const headSx =
    typeof hvoTableHeadHighlightSx === 'function'
      ...
      : hvoTableHeadHighlightSx;
  const bodyRowSx =
    typeof hvoTableBodyRowSx === 'function' ? hvoTableBodyRowSx(theme) : hvoTableBodyRowSx;
        ...
        <>
          <Box sx={hvoBodyListZoneSx}>
            <Box sx={{ ...hvoBodyCardSx, mb: 2.5 }}>
              ...
              <TableContainer sx={{ ...hvoBodyListTableSx, ...hvoTableScrollSx, maxHeight: 420, border: 'none', boxShadow: 'none', borderRadius: 0 }}>
                <Table
                  size="small"
                  stickyHeader
                  sx={{
