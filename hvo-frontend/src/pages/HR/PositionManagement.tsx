...
const POS_FORM_FIELD_SX = { ...hvoSearchFieldSx, ...hvoFilterFieldHeightSx } as const;
...
export const PositionManagementPanel: React.FC<{
  ...
  return (
    <Box sx={hvoPageRootSx}>
      <HvoPageHeader title={t('positionManagement.title')} description={t('positionManagement.description')} />
      {content}
    </Box>
  );
};
