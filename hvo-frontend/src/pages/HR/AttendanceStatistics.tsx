...
const ATTENDANCE_FILTER_OUTLINED = hvoOutlinedLabelProps;
const attendanceFilterFieldSx = { ...hvoSearchFieldSx, ...hvoFilterFieldHeightSx } as const;
...
const AttendanceStatistics: React.FC = () => {
  ...
  return (
    <Box sx={{ ...hvoPageRootSx }}>
      ...
      <Card elevation={0} sx={{ ...hvoBodyCardSx, mb: 3, p: { xs: 1.75, sm: 2.5 } }}>
      ...
      <Card elevation={0} sx={{ ...hvoBodyCardSx, mb: 3 }}>
        ...
        >
          ...
          <Button
            ...
            onClick={load}
            disabled={loading}
            sx={{ ...hvoBodyPrimaryBtnSx, height: 40, whiteSpace: 'nowrap' }}
          >
      ...
      <Dialog open={detailOpen} onClose={closeDetail} maxWidth="md" fullWidth scroll="paper">
        ...
        <DialogContent dividers>
          {detailRows.length === 0 ? (
            ...
            <>
              ...
              <TableContainer sx={{ ...hvoBodyListTableSx, boxShadow: 'none', border: 'none' }}>
        ...
        <DialogActions sx={{ px: 3, py: 2 }}>
          <Button onClick={closeDetail} variant="outlined" sx={hvoBodyOutlinedBtnSx}>
