...
import {
  ...
  hvoBodyPrimaryBtnSx,
  hvoBodySectionHeaderSx,
  hvoBodyToolbarSx,
  hvoPageRootSx,
  hvoSearchFieldSx,
  hvoTableHeadHighlightSx,
  hvoTableScrollSx } from '../../theme/hvoLayout';
...
const VoucherEntry: React.FC = () => {
  ...
  return (
    <Box sx={hvoPageRootSx}>
      <HvoPageHeader title={t('voucherEntry.title')} description={t('voucherEntry.subtitle')} />
      ...
      <Card elevation={0} sx={{ ...hvoBodyCardSx, mb: 2 }}>
        <Tabs
          value={pageTab}
      ...
      <Box sx={hvoBodyListZoneSx}>
        <Card elevation={0} sx={{ ...hvoBodyCardSx, mb: 2 }}>
          ...
          <Box sx={bodyContentSx}>
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <TextField fullWidth size="small" label={t('voucherEntry.voucherNo')} value={voucherNo} InputProps={{ readOnly: true }} sx={hvoSearchFieldSx} />
              </Grid>
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <TextField
                  fullWidth
        ...
        <Card elevation={0} sx={{ ...hvoBodyCardSx, mb: 2 }}>
          <Box sx={{ ...hvoBodyToolbarSx, borderTop: 'none' }}>
            <FormControlLabel
              control={
                <Switch
          ...
          {inputMode === 'simple' ? (
            <>
              ...
              <Box sx={bodyContentSx}>
                <Grid container spacing={2}>
                  <Grid size={{ xs: 12, md: 6 }}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField {...params} size="small" label={t('voucherEntry.party')} placeholder={t('voucherEntry.partySearch')} sx={hvoSearchFieldSx} />
                      )}
                    />
                  </Grid>
                  <Grid size={{ xs: 12, md: 6 }}>
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField {...params} size="small" label={t('voucherEntry.transactionItem')} sx={hvoSearchFieldSx} />
                      )}
                    />
                  </Grid>
                  <Grid size={{ xs: 12, md: 6 }}>
                ...
                {amountRows.length > 0 ? (
                  <Box sx={{ ...hvoBodyToolbarSx, mt: 2, borderRadius: '8px', border: '1px solid #E2E8F0' }}>
                    <Box sx={{ width: '100%' }}>
        ...
        <Box sx={{ ...hvoBodySectionHeaderSx, borderRadius: '8px', border: '1px solid #E2E8F0', boxShadow: '0 1px 2px rgba(15, 23, 42, 0.05)', justifyContent: 'flex-end' }}>
          <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap' }}>
            <Tooltip title={!balanced ? t('voucherEntry.errors.notBalanced') : ''}>
              <span>
                <Button variant="outlined" sx={hvoBodyOutlinedBtnSx} disabled={saving} onClick={() => void handleSave('draft')}>
            ...
            <Tooltip title={!balanced ? t('voucherEntry.errors.notBalanced') : ''}>
              <span>
                <Button variant="contained" disableElevation sx={hvoBodyPrimaryBtnSx} disabled={saving || !balanced} onClick={() => void handleSave('posted')}>
                  {t('voucherEntry.post')}
                </Button>
              </span>
            </Tooltip>
