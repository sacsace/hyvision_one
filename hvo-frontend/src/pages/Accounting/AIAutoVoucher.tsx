...
const AIAutoVoucher: React.FC = () => {
  ...
  const filterFieldSx = { ...hvoSearchFieldSx, ...hvoFilterFieldHeightSx };
  ...
  return (
    <Box sx={hvoPageRootSx}>
      <HvoPageHeader title={t('autoVoucher.title')} description={t('autoVoucher.description')} />
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(2, 1fr)', md: 'repeat(4, 1fr)' }, gap: 2.5, mb: 3 }}>
        {kpis.map((kpi) => (
          <Card key={kpi.key} elevation={0} sx={hvoKpiCardSx}>
      ...
      <Card elevation={0} sx={{ ...hvoBodyCardSx, mb: 0 }}>
        <Box
          sx={{
            display: 'flex',
        ...
        <Box sx={hvoBodyFilterWrapSx}>
          ...
          >
            ...
            <Button variant="outlined" component="label" sx={{ ...hvoBodyOutlinedBtnSx, height: 40 }}>
            ...
            <Button
              ...
              sx={{ ...hvoBodyOutlinedBtnSx, height: 40 }}
          ...
          <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap', alignItems: 'center', mt: 2 }}>
            ...
            />
            <Button variant="contained" disableElevation disabled={askLoading} onClick={() => void handleAsk()} sx={hvoBodyPrimaryBtnSx}>
      ...
      <Box sx={{ ...hvoBodyListZoneSx, display: 'grid', gridTemplateColumns: { xs: '1fr', lg: '1.05fr 1fr' }, gap: 2.5 }}>
        {loading ? (
          ...
          <Box sx={{ px: { xs: 2, sm: 2.5 }, py: 2 }}>
            ...
            {!selected ? (
              ...
              <Box sx={{ display: 'grid', gap: 1.25 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                  <Button variant="outlined" onClick={handleSave} disabled={saving} sx={hvoBodyOutlinedBtnSx}>
      ...
      <Dialog open={rejectOpen} onClose={() => setRejectOpen(false)} fullWidth maxWidth="sm">
        ...
        <DialogContent>
          <TextField
            ...
            sx={{ mt: 1, ...hvoSearchFieldSx }}
          />
        </DialogContent>
        <DialogActions>
          <Button onClick={() => setRejectOpen(false)} sx={hvoBodyOutlinedBtnSx}>
            {t('common.cancel')}
          </Button>
