...
} from '../../components/Common/hvoDialogShell';
import {
  hvoBodyCardSx,
  hvoBodyFilterWrapSx,
  hvoBodyListTableSx,
...
const GeneralLedger: React.FC = () => {
  ...
  return (
    <Box sx={hvoPageRootSx}>
      ...
      {tab === 0 && (
        <>
          <Card elevation={0} sx={{ ...hvoBodyCardSx, mt: 2.5, mb: 0 }}>
      ...
      <Dialog
        ...
        PaperProps={{ sx: getHvoDialogPaperSx(theme) }}
      >
        <DialogTitle sx={{ ...getHvoDialogTitleRowSx(theme), pr: 1 }}>
        ...
        <DialogActions sx={getHvoDialogActionsSx(theme)}>
          <Button onClick={closeVoucherDetail} sx={hvoBodyOutlinedBtnSx}>
            {t('common.close')}
          </Button>
