...
import {
  ...
  hvoTableBodyRowSx,
  hvoOutlinedLabelProps } from '../../theme/hvoLayout';
import {
    ...
    <Box sx={{ ...hvoPageRootSx }}>
      ...
      <Grid container spacing={2.5} sx={{ mb: 3 }} alignItems="stretch">
        <Grid size={{ xs: 12, sm: 6, md: 3 }} sx={{ display: 'flex' }}>
          <Card elevation={0} sx={{ ...hvoKpiCardSx, width: '100%', height: '100%' }}>
        ...
        <>
          ...
          <TabPanel value={activeTab} index={0}>
            <Card elevation={0} sx={hvoBodyCardSx}>
              <Box sx={{ ...hvoBodySectionHeaderSx, alignItems: 'flex-start' }}>
                <Box>
              ...
              <Box sx={{ ...hvoBodyListZoneSx, mt: 0, pb: 0 }}>
                {salesList.length === 0 ? (
          ...
          <TabPanel value={activeTab} index={3}>
            <Grid container spacing={2.5}>
              <Grid size={{ xs: 12, md: 6 }} sx={{ display: 'flex' }}>
                <Card elevation={0} sx={{ ...hvoBodyCardSx, width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
                  <Box sx={hvoBodySectionHeaderSx}>
                    <Typography variant="subtitle1" sx={{ fontWeight: 700, letterSpacing: '-0.01em' }}>
