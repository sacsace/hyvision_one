...
const BalanceSheet: React.FC = () => {
    ...
    return (
      <TableContainer sx={flushTableContainerSx}>
        <Table size="small" sx={{ ...statementTableSx, minWidth: 860 }}>
          <TableHead sx={[hvoTableHeadHighlightSx, compactHeadSx] as any}>
            <TableRow>
              <TableCell width="6%" />
          ...
          <TableBody sx={[hvoTableBodyRowSx, statementBodySx] as any}>
            {lines.map((row, idx) => {
  ...
  return (
    <Box sx={hvoPageRootSx}>
      <HvoPageHeader title={t('balanceSheet.title')} description={t('balanceSheet.description')} />
      ...
      {bsCurrent?.balanced === false ? (
        <Card elevation={0} sx={{ ...hvoBodyCardSx, mb: 2 }}>
          <Box sx={{ ...hvoBodySectionHeaderSx, alignItems: 'flex-start', py: 1.75 }}>
            <Box sx={{ minWidth: 0 }}>
              <Typography
                variant="subtitle1"
        ...
        <Box sx={hvoBodyFilterWrapSx}>
          ...
          >
            ...
            <Button
              ...
              sx={{ ...hvoBodyPrimaryBtnSx, height: 40, whiteSpace: 'nowrap', flex: '0 0 auto' }}
              onClick={() => void load()}
              disabled={loading}
            >
            ...
            <Button
              ...
              sx={{ ...hvoBodyOutlinedBtnSx, height: 40, whiteSpace: 'nowrap', flex: '0 0 auto' }}
              onClick={handleReset}
              disabled={loading}
            >
              {t('common.reset')}
