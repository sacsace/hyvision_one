...
const LS_LEDGER_COLS = 'hvo_gs_enc_ledger_col_widths_v4';
const LS_ACCOUNT_COLS = 'hvo_gs_enc_account_col_widths_v1';
const LS_SUMMARY_COLS = 'hvo_gs_enc_summary_col_widths_v2';
...
const GsEncCostAnalysis: React.FC = () => {
  ...
  return (
    <Box sx={hvoPageRootFullBleedSx}>
      ...
      <Box sx={{ ...hvoBodyListZoneSx, width: '100%', maxWidth: '100%' }}>
        <Box sx={{ ...hvoBodyListTableSx, overflow: 'hidden', width: '100%', maxWidth: '100%' }}>
          <TableContainer
            sx={{
              width: '100%',
              maxWidth: '100%',
          ...
          >
            {tab === 0 && (
              <Table
                stickyHeader
                size="small"
                sx={[hvoTableBodyRowSx, stickyTableSx] as any}
              >
