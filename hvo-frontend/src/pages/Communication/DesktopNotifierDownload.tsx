...
const DOWNLOAD_HREF = `${process.env.PUBLIC_URL || ''}/downloads/hvo-notifier/HVO-Notifier.zip`;
  ...
  return (
    <Box sx={hvoPageRootSx}>
      <HvoPageHeader
        ...
        description={txt(
          '브라우저를 켜지 않아도 Windows 트레이에서 Hyvision One 알림을 받을 수 있습니다.',
          'Receive Hyvision One alerts in the Windows tray without keeping the browser open.'
        )}
      />
        ...
        <CardContent sx={{ p: 2.5 }}>
          ...
          <Typography variant="body2" color="text.secondary" component="div" sx={{ mb: 2 }}>
            <ol style={{ margin: 0, paddingLeft: 18 }}>
              ...
              <li>
                {txt(
                  'API 주소 입력 (예: https://서버주소/api) 후 Hyvision One 계정으로 로그인',
                  'Enter API base (e.g. https://your-host/api) and sign in with your Hyvision One account'
                )}
              </li>
            </ol>
          </Typography>
