...
const RoomBookingManagement: React.FC<RoomBookingManagementProps> = ({
  ...
  if (viewMode === 'view' && selectedBooking) {
    ...
    return (
      <Box sx={{ ...hvoPageRootSx }} className="invoice-print-root">
        ...
        <Card elevation={0} sx={{ ...hvoBodyCardSx, overflow: 'hidden' }}>
          <CardContent
            ref={invoiceRef}
          ...
          >
            ...
            <TableContainer sx={{ ...hvoBodyListTableSx, mb: 1.5 }}>
            ...
            <>
              ...
              <Stack spacing={1}>
                <Button
                  ...
                  sx={{ ...hvoBodyOutlinedBtnSx, justifyContent: 'flex-start' }}
                >
