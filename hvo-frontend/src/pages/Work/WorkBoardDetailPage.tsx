...
import { hvoOutlinedLabelProps, hvoPageContentMaxWidth } from '../../theme/hvoLayout';

const CARD_DETAIL_OUTLINED = hvoOutlinedLabelProps;
  ...
  return (
    <Box
      ...
      sx={{
        ...
        pb: cardDetail ? 2 : 0,
        flex: 1,
        // 카드 세부 입력 시 칸반 full-bleed 대신 일반 바디(hvoPageContentMaxWidth) 폭
        // AppLayout `& > * { width/maxWidth: 100% }` 보다 우선
        width: '100% !important',
        maxWidth: cardDetail ? `${hvoPageContentMaxWidth}px !important` : '100% !important',
        minWidth: 0,
