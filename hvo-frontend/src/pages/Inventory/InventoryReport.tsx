...
const FILTER_OUTLINED = hvoOutlinedLabelProps;
    ...
    <Box sx={{ ...hvoPageRootSx }}>
      ...
      <Card elevation={0} sx={{ ...hvoBodyCardSx, mb: 0 }}>
        <Box sx={hvoBodySectionHeaderSx}>
          ...
          <TextField
            ...
            sx={{ ...hvoSearchFieldSx, ...hvoFilterFieldHeightSx, minWidth: 260 }}
          />
        </Box>
      </Card>
      ...
      <Dialog open={txDialogOpen} onClose={closeTxDialog} maxWidth="md" fullWidth scroll="paper">
        ...
        <DialogContent dividers>
          {txLoading ? (
            ...
            <>
              ...
              <TableContainer sx={{ ...hvoBodyListTableSx, ...hvoTableScrollSx, borderRadius: '8px', overflow: 'hidden' }}>
        ...
        <DialogActions sx={{ px: 3, py: 2 }}>
          <Button onClick={closeTxDialog} variant="contained" disableElevation sx={hvoBodyPrimaryBtnSx}>
