...
const FORM_OUTLINED = hvoOutlinedLabelProps;

const inventoryFilterFieldSx = { ...hvoSearchFieldSx, ...hvoFilterFieldHeightSx } as const;
...
const InventoryManagement: React.FC = () => {
  ...
  return (
    <Box sx={hvoPageRootSx}>
      ...
      <HvoPageHeader title={t('inventoryManagement.pageTitle')} />
