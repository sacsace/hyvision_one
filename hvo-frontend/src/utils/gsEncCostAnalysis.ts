...
const LS_ACCOUNTS = 'hvo_gs_enc_gas_accounts_v1';
const LS_LEDGER = 'hvo_gs_enc_ledger_rows_v1';
const LS_BASIC = 'hvo_gs_enc_basic_info_v1';
const LS_TALLY_MAP = 'hvo_gs_enc_tally_account_map_v1';
