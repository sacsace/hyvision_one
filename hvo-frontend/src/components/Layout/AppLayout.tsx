...
import { hvoPageShellSx, hvoWorkBoardPageBg, hvoPageContentMaxWidth } from '../../theme/hvoLayout';
...
/** 보드·엑셀형 화면은 body 기본 너비 제한 없이 전체 폭 사용 */
...
const AppLayout: React.FC<AppLayoutProps> = ({ children }) => {
  ...
  const bodyMaxWidth = fullBleedBody ? '100%' : hvoPageContentMaxWidth;
    ...
    <Box
      sx={{
        ...
        ...(useChromelessWorkArea
          ? { background: hvoWorkBoardPageBg, backgroundColor: 'transparent' }
          : {}),
