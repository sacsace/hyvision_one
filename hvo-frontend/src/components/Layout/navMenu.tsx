...
const getIconByRoute = (route: string): React.ReactElement | null => {
  ...
  if (normalized.startsWith('/purchase')) return <LocalShipping />;
  if (normalized.startsWith('/mfg')) return <Inventory />;
  if (normalized.startsWith('/hq')) return <Assessment />;
...
export const getMenuIcon = (menu: Menu): React.ReactElement => {
  ...
  if (ko.includes('구매') || en.includes('purchase') || en.includes('procurement')) return <LocalShipping />;
  if (ko.includes('제조') || en.includes('manufacturing')) return <Inventory />;
  if (ko.includes('본사') || en.includes('hq') || en.includes('head office')) return <Assessment />;
  ...
  if (ko.includes('호텔') || ko.includes('기숙사') || en.includes('hotel') || en.includes('dormitory')) return <Dashboard />;
