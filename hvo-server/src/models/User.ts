...
interface UserAttributes {
  ...
  /** Korea HQ portal role — separate from users.role ENUM */
...
class User extends Model<UserAttributes, UserCreationAttributes> implements UserAttributes {
  ...
  public hq_role?: 'hq_admin' | 'hq_management' | 'hq_finance' | 'hq_production' | 'hq_auditor' | 'hq_readonly' | null;
  public hq_access_level?: 'kpi_only' | 'reports' | 'txn_detail' | 'attachments' | 'export' | 'approve' | 'modify' | 'admin';
  public hq_can_approve?: boolean;
  public hq_can_view_cost?: boolean;
  public hq_can_view_hr_pii?: boolean;
  public hq_can_view_bank_detail?: boolean;
  public hq_can_view_tax?: boolean;
  public hq_home_timezone?: string;
