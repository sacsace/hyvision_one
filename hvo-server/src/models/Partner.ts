...
class Partner extends Model<PartnerAttributes, PartnerCreationAttributes> implements PartnerAttributes {
  ...
  public tan_number?: string | null;
  public state_code?: string | null;
  public partner_category?: string | null;
  public msme_udyam?: string | null;
  public payment_terms?: string | null;
  public currency_code?: string;
  public tds_applicable?: boolean;
...
Partner.init(
  {
    ...
    trade_name: { type: DataTypes.STRING(200), allowNull: true },
    tan_number: { type: DataTypes.STRING(20), allowNull: true },
    state_code: { type: DataTypes.STRING(5), allowNull: true },
    partner_category: { type: DataTypes.STRING(30), allowNull: true },
    msme_udyam: { type: DataTypes.STRING(50), allowNull: true },
    ...
    tds_applicable: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    created_at: {
      type: DataTypes.DATE,
      allowNull: false,
