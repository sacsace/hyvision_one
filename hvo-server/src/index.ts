// Hyvision One Backend - 실제 데이터베이스 연동 서버
...
app.get('/', (req, res) => {
  res.json({
    message: 'Hyvision One Backend Server',
    version: '3.0.0',
    status: 'running',
...
app.use('/api/integrations/hvo/dispatch', uploadLimiter);
...
server.listen(PORT, HOST, () => {
  console.log(`🚀 Hyvision One Backend Server running on ${HOST}:${PORT}`);
